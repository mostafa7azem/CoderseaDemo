 ...
 * Generated for Laravel 6.14.0 on 2020-02-12 11:15:50.
 *
...
namespace STS\ZipStream {
    ...
    class ZipStreamFacade {
         ...
         *
         *
         * @param string|\STS\ZipStream\FileContract $source
         ...
         *
         *
         * @return \STS\ZipStream\Collection
         * @static
         */
         ...
         *
         *
         * @return \STS\ZipStream\StreamedResponse
         * @static
         */
         ...
         *
         *
         * @param string|\STS\ZipStream\FileContract $output
         * @return \STS\ZipStream\ZipStream
         * @static
         */
         ...
         * @param \ZipStream\FileOptions $options File Options:
         ...
         *
         * @param String $name - path of file in archive (including directory).
         * @param \ZipStream\StreamInterface $stream - contents of file as a stream resource
         * @param \ZipStream\FileOptions $options File Options:
         *  time     - Last-modified timestamp (seconds since the epoch) of
         *             this file.  Defaults to the current time.
         *  comment  - Comment related to this file.
